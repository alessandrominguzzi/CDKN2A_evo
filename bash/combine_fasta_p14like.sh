...
# Launch this script exclusively inside the folder 'p14_candidates_blastn' 
# entire path here: ~/CDKN2A_evo/raw_data/sequences/p14_candidates_blastn
# this ensures that only p14 candidates found by blastn are included 
